...
#'
#' @param Object Either a matrix (rows = observations, columns = variables;
#'        to be passed to \code{infoDim}) or
#'       an object (a list) generated by function \code{\link{infoDim}}.
#'
...
qplot_infoDim <- function(Object, n.comp.SHOW = 20,
                          selected = NA,
                          Title = "Scree Plot",
                          y.log = TRUE,
                          show.legend = TRUE,
    ...
    annotations <- data.frame(
        Dim    = Object$exactDim,
        Legend = sprintf("Information dimension = %.1f",Object$exactDim),
        selected    = selected,
