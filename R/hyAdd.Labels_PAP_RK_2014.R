...
hyAdd.Labels_PAP_RK_2014 <- function(sp, language = "EN")  {
    ...
    data$Gimimo_data <- as.POSIXlt(data$Gimimo_data)
    ...
    Var.Labels <- switch(language,
           LT =   c(
               ...
               "Bylos aplankas",
               "Bylos pavadinimas",
               "Spektrų registravimo data",
               "Tyrėjas",
               "Integracijos laikas, s",
               "Integracijos laikas (perskaičiuotas), s",
               "Electric_dark_correction",
               "Nonlinearity_correction",
               "Meginių partija",
               "Gimimo data",
               "Hibridinė dignozė 2014",
               "Citologinė diagnozė 2014",
               "Citologinė diagnozė 2015",
               "Histologinė diagnozė 2014",
               "Histologinė diagnozė 2015",
               "ZPV 16",
               "ZPV 18",
