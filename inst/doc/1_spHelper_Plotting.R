## ----options 1, echo = FALSE, message = FALSE, warning = FALSE-----------
...
## ----plot_stat 1---------------------------------------------------------
 ...
 plot_stat(chondro,clusters,mean_sd,All = FALSE) +
     facet_grid(.~clusters) +
     nTick_x()
 ...
 plot_stat(chondro,clusters,mean_pm_sd) +
     facet_grid(.~clusters) +
     nTick_x()
...
## ----plot_stat 2---------------------------------------------------------
 ...
 plot_stat(Spectra,gr,mean_sd,All = FALSE) +
     facet_grid(.~gr) +
     nTick_x()
...
plot_stat(Spectra,gr,mean_pm_sd) +
     facet_grid(.~gr) +
     nTick_x()
